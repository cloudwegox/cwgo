...
cwgo 基于[Apache License 2.0](https://github.com/cloudwegox/cwgo/blob/main/LICENSE) 许可证，其依赖的三方组件的开源许可见 [Licenses](https://github.com/cloudwegox/cwgo/blob/main/licenses)。

...
func TestJobValidCreation(t *testing.T) {
	args := &config.JobArgument{
		JobName:       []string{"job1"},
		GoMod:         "github.com/cloudwegox/cwgo",
		PackagePrefix: "github.com/cloudwegox/cwgo",
		OutDir:        "./test_out",
	}
...
`
	jobs := []JobInfo{
		{JobName: "job1", PackagePrefix: "github.com/cloudwegox/cwgo"},
		{JobName: "job2", PackagePrefix: "github.com/cloudwegox/cwgo"},
	}
...
import (
	"sync"
	job1 "github.com/cloudwegox/cwgo/job1/job"
	job2 "github.com/cloudwegox/cwgo/job2/job"
)
